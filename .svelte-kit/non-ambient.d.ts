...
declare module "$app/types" {
	export interface AppTypes {
		...
		Pathname(): "/" | "/privacy" | "/privacy/" | "/requirements" | "/requirements/" | "/shop" | "/shop/" | "/shop/confirmation" | "/shop/confirmation/" | "/shop/process" | "/shop/process/" | "/submissions" | "/submissions/" | `/submissions/${string}` & {} | `/submissions/${string}/` & {};
